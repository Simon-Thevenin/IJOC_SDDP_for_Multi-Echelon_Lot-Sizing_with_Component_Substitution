...
class InstanceReaderTemplemeier(InstanceReader):
    ...
    def GenerateTransportCost(self, alternatetype):
        ...
        if alternatetype == "distribution_at_last_echelon":
            if self.Filename[0] == "G":
               self.Instance.Requirements[1][4] = 0
               self.Instance.Alternates[4][5] = 1
               self.Instance.AternateCosts[5][4] = -1
               self.Instance.Requirements[2][6] = 0
               self.Instance.Alternates[6][5] = -1
               self.Instance.AternateCosts[5][6] = 1
